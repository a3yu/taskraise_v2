...
export default function SideBar({ full_name }: { full_name: string | null }) {
  ...
  const tabs = useMemo(() => {
    return [
      ...
      },
      {
        ...
        isActive: segments[1] === "marketplace",
  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <div className="mb-4 border-t border-stone-200 dark:border-stone w-full" />
          <DropdownMenu>
